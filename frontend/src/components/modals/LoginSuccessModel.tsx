...
export const LoginSuccessModal: React.FC<LoginSuccessModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 px-4 py-5">
      <div className="relative w-full max-w-md rounded-lg bg-primary px-8 py-12 text-center">
