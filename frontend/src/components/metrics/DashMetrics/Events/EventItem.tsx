 ...
 */
export const EventItem: React.FC<{ item: ActivityItemProps }> = ({ item }) => {
  return (
    <div className="rounded-[5px] border border-stroke p-5 dark:border-strokedark">
      ...
      <div className="mb-3 flex items-center justify-between">
        ...
        <div className="text-right">
          ...
          <p className="text-sm">{item.formattedEventDate}</p>
        </div>
      </div>
      {/* Countdown Timer */}
      <div className="countdown-wrapper flex flex-nowrap items-center justify-center w-full mt-5">
